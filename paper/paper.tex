...
\input{figures/fig2_gha_workflow}
...
\caption{Detection and recovery time across all 20 failure-injection runs.
Detection (blue) is consistently faster and tighter than recovery (orange)
across every run, and both are stable run-to-run — neither shows a trend
over the sequence of 20 trials, supporting the claim that these are
steady-state properties of the pipeline rather than artifacts of run order.}
